...
public class RecommendLikeAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_recommend_like_view, parent, false);
    ...
    class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mTextView2 = (TextView) view.findViewById(R.id.mark_tv2);
            mTextView3 = (TextView) view.findViewById(R.id.mark_tv3);
        ...
        public void setData(HotBeen hotBeen) {
            mHotBeen=hotBeen;
            mTextView1.setVisibility(hotBeen.isShow1()?View.VISIBLE:View.GONE);
            mTextView2.setVisibility(hotBeen.isShow2()?View.VISIBLE:View.GONE);
            mTextView3.setVisibility(hotBeen.isShow3()?View.VISIBLE:View.GONE);
