...
public class BannerShop extends RelativeLayout {

    private ViewPager mViewPager;
    private TextView mCurrentPosition;
    private TextView mTotalNumber;
    private int[] mImages = {R.drawable.img1,R.drawable.img1,R.drawable.img1,R.drawable.img1,R.drawable.img1};

    public BannerShop(Context context) {
        this(context,null);
    }

    public BannerShop(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(getContext()).inflate(R.layout.banner_shop,this);
