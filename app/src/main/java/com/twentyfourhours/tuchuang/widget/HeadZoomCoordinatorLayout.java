...
public class HeadZoomCoordinatorLayout extends CoordinatorLayout {
    ...
    public HeadZoomCoordinatorLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HeadZoomCoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
