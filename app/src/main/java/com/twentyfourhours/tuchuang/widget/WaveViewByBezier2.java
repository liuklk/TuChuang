...
public class WaveViewByBezier2 extends View {
     ...
     * 波形的颜色
     */
    private int waveColor = 0xff282828;//0xaa000000
    ...
    public WaveViewByBezier2(Context context) {
        this(context, null);

    }

    public WaveViewByBezier2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
