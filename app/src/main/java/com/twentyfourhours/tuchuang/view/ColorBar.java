...
public class ColorBar extends View {
     ...
     * 滑块当前的位置
     */
    private int currentThumbOffset = 10*thumbRadius;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {//点击时
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (currentThumbOffset >= barWidth + thumbRadius)
                    currentThumbOffset = barWidth + thumbRadius;
                if (mOnColorBarChangeListener!=null){
                    mOnColorBarChangeListener.onColorBarChange(getCurrentColor());
                }
                break;
    ...
    private void setOnColorBarChangeListener(OnColorBarChangeListener listener){
        mOnColorBarChangeListener=listener;
    }

    private OnColorBarChangeListener mOnColorBarChangeListener;

    public interface OnColorBarChangeListener{
        void onColorBarChange(int color);
    }
}
